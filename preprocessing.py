...
def preprocess(image, clusters):
	print "Quantizing..."
	quant = CQ.quantize(clusters, image)
	...
	print "Choosing text sample..."
	SSamp.select(quant, "text")
	print "Choosing nonetext sample..."
